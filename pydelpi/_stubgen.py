...
def generate_stub_files(out_dir):
    ...
    # They have a structure like 'bazel-out/k8-fastbuild/bin/pydelpi/_pydelpi.pyi'
    # We need the path up to 'bin' to generate the stubs
    old_argv = sys.argv
    sys.argv = [sys.argv[0], "pydelpi", "-o", out_dir]
    stubgen_main()
    sys.argv = old_argv
...
def main():
    assert len(sys.argv) == 4, "Usage: python -m pydelpi._stubgen <output_file> <output_file> <output_file>"
