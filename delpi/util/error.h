...
#define DELPI_NOT_IMPLEMENTED() throw ::delpi::DelpiNotImplementedException()
...
#define DELPI_NOT_IMPLEMENTED()                                                                             \
  do {                                                                                                      \
    DELPI_CRITICAL_FMT("{}:{} Not implemented.", __FILE__, __LINE__);                                       \
    throw ::delpi::DelpiNotImplementedException(fmt::format("{}:{} Not implemented.", __FILE__, __LINE__)); \
  } while (false)
