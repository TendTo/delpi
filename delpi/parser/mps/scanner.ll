...
#define __DELPI_MPS_SCANNER_H__ // prevent inclusion of the flex header two times
...
typedef delpi::mps::MpsParser::token token;
typedef delpi::mps::MpsParser::token_type token_type;
...
#undef YY_DECL
#define YY_DECL                                                                                                     \
  delpi::mps::MpsParser::token_type delpi::mps::MpsScanner::lex(delpi::mps::MpsParser::semantic_type *yylval, \
                                                                    delpi::mps::MpsParser::location_type *yylloc)
%}
