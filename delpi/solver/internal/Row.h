...
/**
 * Structure representing a row in the LP solver in the form of a linear combination of columns.
 ...
 */
struct Row {
  std::vector<std::pair<Index, mpq_class>> addends;  ///< Linear combination of columns
...
OSTREAM_FORMATTER(delpi::internal::Row)
